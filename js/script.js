...
const paragraph = querySelectorAll("p");
...
//Question 6: Select the div with a class of results, assign it to a variable called resultsContainer and set its 
//inner HTML to be <p>New paragraph</p> and its background colour to be yellow.

resultsContainer = querySelector(".results");
...
function allTheProperties(list) { 
...
function createCats(cats) {
    ...
    for(let i = 0; i < cats.length; i++) {
        ...
        let birthYear = "Unknown year";

        if(cats[i].age) {
            birthYear = cats[i].age;
        }
